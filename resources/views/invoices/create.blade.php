...
@section('content')
	...
	@component('partials.section-with-container')
		...
		@if (!commonCount('invoice-groups'))
			@component('partials.alerts.warning')
				@icon('warning') Please create an <a href="{{ route('invoice-groups.create') }}">invoice group</a> before creating invoices.
			@endcomponent
		@else
					...
					@slot('body')
						...
						@component('partials.form-group')
							...
							<select name="invoice_group_id" class="form-control">
								@foreach (common('invoice-groups') as $invoice_group)
